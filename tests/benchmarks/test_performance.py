...
class TestCachePerformance:
    ...
    def test_cache_write_performance(self, benchmark):
        ...
        result = benchmark(write_ops)
        print(f"\nCache write (100 ops): {result:.4f}s")
    ...
    def test_cache_read_performance(self, benchmark):
        ...
        result = benchmark(read_ops)
        print(f"\nCache read (100 ops): {result:.4f}s")
...
class TestConfigPerformance:
    ...
    def test_config_access_performance(self, benchmark):
        ...
        print(f"\nConfig access time: {result:.6f}s")
